...
const Intro = () => {
  return (
    <div className="w-full relative py-10 border-slate-800 ">
      <div className="main w-[90%] md:4/5 lg:w-3/4 m-auto h-auto flex-col md:flex-row flex justify-center gap-10 items-center p-5 md: border-slate-950">
        ...
        <div className="side-2 md:w-1/2 flex justify-center flex-col">
          <h2 className="text-2xl md:text-3xl text-center font-bold" >Hi, Im Maggie, a Skilled Administrative Support Professional</h2>
